...
Common labels
*/}}
{{- define "namesrv.labels" -}}
helm.sh/chart: {{ include "namesrv.chart" . }}
{{ include "namesrv.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "namesrv.selectorLabels" -}}
app.kubernetes.io/name: {{ include "namesrv.name" . }}-namesrv
